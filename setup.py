...
setup(
    ...
    download_url="http://pypi.python.org/packages/source/f/funkload/funkload-%s.tar.gz"
    % __version__,
    license="GPL",
    ...
    install_requires=["webunit  >= 1.3.8", "docutils >= 0.3.7", "setuptools"],
    zip_safe=True,
    package_data={
        "funkload": [
            "data/*",
